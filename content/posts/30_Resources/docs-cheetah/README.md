...
| **算法公式** | [13-algorithms-and-formulas.md](./13-algorithms-and-formulas.md) | 动力学、KF、MPC、WBC、Balance QP 数学推导与源码对照 |
| **空间向量** | [14-spatial-vector-algebra.md](./14-spatial-vector-algebra.md) | `spatial.h` 约定、公式、API 与 CRBA/RNEA/ABA 关系 |
...
**算法推导**：13 算法公式（含 KF/MPC/QP 完整数学式）→ 对应章节 API。  
...
**文档版本**：共 15 章（00–14），约 4500+ 行；涵盖动力学、估计、MPC/WBC、FSM、运行时、碰撞、参数示例、核心算法公式与空间向量代数。
