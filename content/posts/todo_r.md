...
- **内容摘要**：  
  ...
  领域分四类：  
  物理世界（机器人、自动驾驶）、数字世界（网页浏览器、代码、GUI）、社会世界（多智能体交互、社会模拟）、科学世界（天气预报、材料发现、药物设计）。  
...
- **内容**（原始推文）：  
  ...
  • ThinkJEPA：采用 dense 物理预测结合 VLM 推理。最适合用于需要长期战略  

## 二、扩散模型 / 流匹配 / 生成模型

### 1. 扩散模型的统一理论基础：薛定谔桥
- **来源**：alphaXiv @askalphaxiv  
- **内容**：  
  《薛定谔桥在生成建模中的基础》  
...
### 8. 漂移模型与基于分数模型的统一视角
- **作者**：Chieh-Hsin (Jesse) Lai @JCJesseLai  
- **内容**：  
  [1/D]  
  🤔 漂移模型到底与什么相关？  
...
## 三、LLM / 注意力机制 / LoRA 变体 / 架构

### 1. LLM 内部机制教程（LLM Internals）
...
### 6. 从零构建 LLM（官方代码库）
- **作者**：Shubham tiwari @Shubham9340x  
- **内容**：  
  从零开始构建大型语言模型！  
...
### 1. 视频世界模型在机器人控制中的两大范式（附 36 篇参考文献）
- **作者**：Tongzhou Mu 🤖🦾🦿 @tongzhou_mu  
- **内容**（完整保留）：  
  ...
  **参考文献**（完整列表）：  
  ...
  [1] DreamGen: Unlocking Generalization in Robot Learning through Video World Models (2025)  ([arXiv](https://arxiv.org/abs/2505.12705))  
  [2] GR00T N1: An Open Foundation Model for Generalist Humanoid Robots (2025)  ([arXiv](https://arxiv.org/abs/2503.14734))  
  [3] Interactive World Simulator for Robot Policy Training and Evaluation (2026)  ([arXiv](https://arxiv.org/abs/2603.08546))  
  [4] UniSim: Learning Interactive Real-World Simulators (2023)  
  [5] V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning (2025)  ([arXiv](https://arxiv.org/abs/2506.09985))  
  [6] Learning what you can do before doing anything (2023)  ([arXiv](https://arxiv.org/abs/1806.09655))  
  [7] Structured World Models from Human Videos (2023)  ([arXiv](https://arxiv.org/abs/2308.10901))  
  [8] Video Language Planning (2023)  ([arXiv](https://arxiv.org/abs/2310.10625))  
  [9] Strengthening Generative Robot Policies through Predictive World Modeling (2025)  
  [10] DreamDojo: A Generalist Robot World Model from Large-Scale Human Videos (2026)  ([arXiv](https://arxiv.org/abs/2602.06949))  
  [11] Cosmos Policy: Fine-Tuning Video Models for Visuomotor Control and Planning (2026)  ([arXiv](https://arxiv.org/abs/2601.16163))  
  [12] Evaluating Gemini Robotics Policies in a Veo World Simulator (2025)  ([arXiv](https://arxiv.org/abs/2512.10675))  
  [13] IRASim: A Fine-Grained World Model for Robot Manipulation (2024)  ([arXiv](https://arxiv.org/abs/2406.14540))  
  [14] 1X World Model: Evaluating Bits, not Atoms (2024)  
  [15] Ctrl-World: A Controllable Generative World Model for Robot Manipulation (2025)  ([arXiv](https://arxiv.org/abs/2510.10125))  
  [16] DreamZero: World Action Models are Zero-shot Policies (2026)  
  [17] Motus: A Unified Latent Action World Model (2025)  ([arXiv](https://arxiv.org/abs/2512.13030))  
  [18] Prediction with Action: Visual Policy Learning via Joint Denoising Process (2024)  ([arXiv](https://arxiv.org/abs/2411.18179))  
  [19] Unleashing Large-Scale Video Generative Pre-training for Visual Robot Manipulation (2024)  ([arXiv](https://arxiv.org/abs/2312.13139))  
  [20] GR-2: A Generative Video-Language-Action Model with Web-Scale Knowledge (2024)  ([arXiv](https://arxiv.org/abs/2410.06158))  
...
- **内容**：  
  我们与 @NVIDIA 合作，教你关于强化学习和强化学习环境的知识。  
...
### 7. MIT 18.065 第34讲：距离矩阵与Procrustes问题
- **作者**：Chao Ma @ickma2311  
- **内容**：  
...
- **来源**：Ksenia_TuringPost @TheTuringPost  
- **内容**：  
  如果你在机器学习领域，很可能你已经完成 @AndrewYNg 了机器学习专业。  
...
### 1. Lucidrains 的经典重制代码库
- **作者**：wesley hsieh @chengyenhsieh  
- **内容**：  
...
### 3. Unsloth：用 RL 训练 Qwen3.5（只需8GB显存）
- **作者**：Unsloth AI @UnslothAI  
- **内容**：  
...
### 1. bfloat16 精度对散点图的影响
- **作者**：John Carmack @ID_AA_Carmack  
- **内容**：  
...
### 2. ICLR 2026 海报：扩散模型的有趣特性（NoiseRefine）
- **作者**：Sayak Paul @RisingSayak  
- **内容**：  
...
### 4. ICLR 2026 演讲：从 MDP 到 GCMDP
- **作者**：Chongyi Zheng （已在上文强化学习部分收录）
