...
subtitle: "扩散模型原理：从起源到进展"
date: 2026-02-28T10:26:59+08:00
# lastmod: 2026-02-28T10:26:59+08:00
draft: false
authors: [Steven]
description: "扩散模型原理专著：从变分视角（VAE→DDPM）、分数视角（EBM→NCSN→分数 SDE）到流视角（NF→流匹配），并统一福克–普朗克方程下的条件化与采样/加速（引导、数值求解器、蒸馏、从零学习）方法。"
...
featuredImage: ""
featuredImagePreview: "/mywebsite/posts/70 Attachments/images/the-principles-of-diffusion-models.webp"
...
**第四部分 D**（第 10–11 章）则涵盖基于训练的加速：蒸馏与从零学习快速生成器。
---
